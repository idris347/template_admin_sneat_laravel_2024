        ...
        <div class="col-lg-6 col-md-12 col-6 mb-4">
          <div class="card">
            <div class="card-body">
              ...
              <h3 class="card-title mb-2"><div class="fs-5 text-primary text-center">{{ $user == 0 ? 'data kosong' : $user}}</div></h3>
              <small class="text-success fw-semibold d-flex justify-content-center " ><i class="bx bx-up-arrow-alt "></i> Data</small>
            </div>
          </div>
        </div>
        <div class="col-lg-6 col-md-12 col-6 mb-4">
